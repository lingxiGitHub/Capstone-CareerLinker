...
def connected(otherUserId):
    ...
    connection = Connection.query.filter(
        ...
        & (Connection.connected_user_id == otherUserId)
        | (Connection.user_id == otherUserId)
...
def add_a_connection():
    ...
    search = Connection.query.filter_by(
...
def delete_a_connection():
    ...
    found_connection = Connection.query.filter(
        db.or_(
            Connection.user_id == the_user_id,
            Connection.connected_user_id == the_user_id,
        )
    ).first()
