...
class SignUpForm(FlaskForm):
    ...
    first_name = StringField ("first_name",validators=[DataRequired(), Length(min=2,max=20,message="First name must be between 2 - 20 charaters")])
    last_name = StringField ("last_name",validators=[DataRequired(), Length(min=2,max=20,message="Last name must be between 2 - 20 charaters")])
