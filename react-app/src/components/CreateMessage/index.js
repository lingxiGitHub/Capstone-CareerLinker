...
import { addMessageThunk, getAllMessages, getSingleMessage } from "../../store/message";
...
export default function CreateMessageBox({ conversationId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        messageContainerElement && messageContainerElement.scrollTo(0, messageContainerElement.scrollHeight)
