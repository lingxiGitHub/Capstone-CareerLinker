...
export default function MessageThreeDots({ messageId, conversationId, message }) {


    const messageThreeDotsSvg = (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" data-supported-dps="16x16" fill="currentColor" class="mercado-match" width="16" height="16" focusable="false">
            ...
            <ul className={ulClassName} ref={ulRef}>
                ...
                <li className="three-dots-li">
                    <OpenModalButton
                        ...
                        modalComponent={<DeleteMessageComponent
                ...
                <li className="three-dots-li">
                    <OpenModalButton
                        buttonText="Edit"
                        className="edit-delete-button"
                        modalComponent={<EditMessageComponent
                            message={message}
                            conversationId={conversationId}
                        />}
                    />
